    ...
    : QWidget(parent)
{
    ...
    m_timeCheck->setStyleSheet("font: 8pt 'Comic Sans MS'; background:  rgba(255,255,255,180); border: 1px solid #FFB6C1; border-radius: 8px; padding: 4px;");
    m_weatherCheck->setStyleSheet("font: 8pt 'Comic Sans MS'; background:  rgba(255,255,255,180); border: 1px solid #FFB6C1; border-radius: 8px; padding: 4px;");
    m_todosCheck->setStyleSheet("font: 8pt 'Comic Sans MS'; background:  rgba(255,255,255,180); border: 1px solid #FFB6C1; border-radius: 8px; padding: 4px;");
...
void PetMenu::setRoleComboEnabled(bool enabled)
{
